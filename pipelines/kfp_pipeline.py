    ...
    def build_dag(self):
        ...
        def biometric_pipeline(ingest_cfg: str, preprocess_cfg: str, build_cfg: str, train_cfg: str, evaluate_cfg: str):
            ...
            preprocess = (preprocess_op(cfg_json=preprocess_cfg, input_parquet=ingest.outputs["output_parquet"]).
                          set_cpu_request(str(self.cfg.components.preprocessing.compute.cpu_request)).
                          set_memory_request(str(self.cfg.components.preprocessing.compute.memory_request)))
            ...
            train = (train_model_op(cfg_json=train_cfg, input_npz=preprocess.outputs["output_npz"],
                                    input_model=build.outputs["output_model"]).set_gpu_limit(
                str(self.cfg.components.training.compute.gpu_limit)).
                set_cpu_request(str(self.cfg.components.training.compute.cpu_request)).
                set_memory_request(str(self.cfg.components.training.compute.memory_request)))
